...
export const getWorkSubCategoryById = (
  id: number
): WorkSubCategory | undefined => {
...
export const getWorkSubCategoriesByDepartmentFlag = (
  departmentFlag: number
): WorkSubCategory[] => {
  return workSubCategories.filter(
    (subCategory) =>
      subCategory.department_flag === departmentFlag &&
